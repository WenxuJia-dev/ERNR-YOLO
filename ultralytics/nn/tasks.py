...
from ultralytics.nn.modules.HWD import *
from ultralytics.nn.modules.Neck import *
from ultralytics.nn.modules.BiFPN import Bi_FPN
...
class BaseModel(nn.Module):
    ...
    def _apply(self, fn):
        ...
        if isinstance(m,( Detect,Detect_AFPN,Detect_FASFF)):  # includes all Detect subclasses like Segment, Pose, OBB, WorldDetect
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        elif m in (Detect,WorldDetect, Segment, Pose, ImagePoolingAttn):
    ...
    if isinstance(model, nn.Module):  # PyTorch model
        ...
        for m in model.modules():
            if isinstance(m, Segment):
                ...
                return "obb"
            elif isinstance(m, (Detect,Detect_AFPN, WorldDetect)):
                return "detect"
